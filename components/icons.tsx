...
export const PaintBrushIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9.53 16.122a3 3 0 0 0-5.78 1.128 2.25 2.25 0 0 1-2.475 2.118A2.25 2.25 0 0 1 .879 16.5a2.25 2.25 0 0 1 2.25-2.25h1.524c.074 0 .147.01.22.029m7.538-4.321a3 3 0 0 0-4.321-4.321l-1.263.947c-.504.378-.865.998-.963 1.635A3 3 0 0 0 1.5 12c0 1.657 1.343 3 3 3h.538a3 3 0 0 0 3-3v-.538a3 3 0 0 0-.823-2.122l-1.263-.947M12.75 12.75a3 3 0 0 0-3-3M15.75 15.75a3 3 0 0 0-3-3M6 21a2.25 2.25 0 0 1-2.25-2.25h15a2.25 2.25 0 0 1-2.25 2.25H6Z" />
    </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72.372a3.527 3.527 0 0 1-3.296-2.027l-1.003-2.006a3.527 3.527 0 0 0-3.296-2.027l-3.72.372A2.122 2.122 0 0 1 3.75 14.5v-4.286c0-.97.616-1.813 1.5-2.097m6.006 0a3.527 3.527 0 0 0-3.296-2.027l-3.72.372A2.122 2.122 0 0 0 3.75 6.5v4.286c0 .97-.616 1.813-1.5 2.097M14.25 8.511a3.527 3.527 0 0 1 3.296-2.027l3.72.372a2.122 2.122 0 0 1 1.98 2.193v4.286c0 1.136.847 2.1 1.98 2.193l-3.72.372a3.527 3.527 0 0 1-3.296-2.027l-1.003-2.006a3.527 3.527 0 0 0-3.296-2.027l-3.72.372" />
    </svg>
);
...
export const LightBulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 0 0 1.5-.189m-1.5.189a6.01 6.01 0 0 1-1.5-.189m3.75 7.478a12.06 12.06 0 0 1-4.5 0m3.75 2.25h.008v.008h-.008v-.008zM9.75 21a2.25 2.25 0 0 1-2.25-2.25h11.25a2.25 2.25 0 0 1-2.25 2.25h-6.75z" />
    </svg>
);

export const DocumentMagnifyingGlassIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 15.828v-2.828a2.25 2.25 0 0 0-2.25-2.25h-6a2.25 2.25 0 0 0-2.25 2.25v2.828m0 0A3.375 3.375 0 0 0 5.625 18h12.75c1.29 0 2.446-.666 3.063-1.713a3.375 3.375 0 0 0-3.063 1.713H5.625A3.375 3.375 0 0 0 3 15.172V7.875A2.25 2.25 0 0 1 5.25 5.625h13.5A2.25 2.25 0 0 1 21 7.875v7.297M11.025 15.485a3.75 3.75 0 1 0 0-5.304 3.75 3.75 0 0 0 0 5.304Z M14.25 18.75l3 3" />
    </svg>
);
